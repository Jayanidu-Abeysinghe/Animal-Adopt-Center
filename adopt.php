...
<body>
    <main style="background-color: rgb(251, 245, 235);">
        <section class="adopt-section">
            ...
            <div id="adoption-form">
                ...
                <form action="adoptb.php" method="post">
    ...
    <button type="submit" class="btn">Submit Application</button>
                    ...
                    <button type="submit" formaction="update-adoption.php" class="btn"> <a href = "update.php"> Update Application </a> </button>
                    <button type="submit" formaction="delete-adoption.php" class="btn" style="background-color: red; color: white;">Delete Application</button>
